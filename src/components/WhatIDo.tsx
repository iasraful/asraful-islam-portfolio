        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Specializing in Shopify Theme and App development. I build
                highly customized, performant storefronts and private apps.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">Liquid</div>
                <div className="what-tags">Remix</div>
                <div className="what-tags">Shopify API</div>
                <div className="what-tags">Polaris</div>
                <div className="what-tags">GraphQL</div>
                <div className="what-tags">Webhook</div>
                <div className="what-tags">Node.js</div>
              </div>
              <div className="what-arrow"></div>
            </div>
